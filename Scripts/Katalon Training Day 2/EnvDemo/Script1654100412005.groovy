...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_OrangeHRM/input_Username_txtPassword'), 'vJSloWqxftZ+pSxd8ENkxw==')

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/form_LOGIN Panel                           _b98207'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/div_LOGIN Panel                            _c4431b'))
